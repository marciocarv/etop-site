			  ...
			  <div class="nav-collapse collapse">
				  <ul class="nav pull-right">
					  ...
					  <li class="dropdown">
						  ...
						  <ul class="dropdown-menu">
							  <li><a href="?p=cursos/todos">Ver todos os cursos</a></li>
							  <li><a href="?p=cursos/administrativos">Administrativos</a></li>
							  <li><a href="?p=cursos/ead">Cursos EAD</a></li>
							  <li><a href="?p=cursos/industriais">Industriais</a></li>
							  <li><a href="?p=cursos/informatica">Inform&aacute;tica</a></li>
							  <li><a href="?p=cursos/idiomas">Idiomas</a></li>
					  ...
					  <li class="dropdown">
						  ...
						  <ul class="dropdown-menu">
							  ...
							  <li><a href="?p=noticias">Not&iacute;cias</a></li>
							  <li><a href="?p=album">Fotos</a></li>
