...
<div class="container module">
  <div class="title">
    <h3>Alterar Página: Metodologia</h3>
  </div>
  <div class="form-module">
    <form class="form-horizontal" method="POST" action="{{route('update-methodology')}}">
      @csrf
        <div class="control-group">
          <label class="control-label" for="inputDescription">metodologia:</label>
          <div class="controls">
            <textarea rows="5" name="content" id="content">{{$methodology->content}}</textarea>
          </div>
      </div>
      <div class="control-group">
        <div class="controls">
